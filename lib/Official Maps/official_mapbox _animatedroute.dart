...
//         final position = Position(77.6408,12.9784);
...
//       final myCoordinate = Position(77.641151,12.971891);
...
//         // Point(coordinates: createRandomPositionAround(myCoordinate)),
//         // Point(coordinates: createRandomPositionAround(myCoordinate)),
//         Point(coordinates: Position(77.580643,12.972442)),
//         Point(coordinates: Position(77.611151,12.973891)),
//         Point(coordinates: Position(77.661151,12.974891)),
//         Point(coordinates: Position(77.621151,12.974091)),
//       ];
//
//       final ByteData bytes =
//       await rootBundle.load('assets/images/Group 71.png');
//       final Uint8List imageData = bytes.buffer.asUint8List();
//
//       for (Point coordinate in coordinates) {
//         pointAnnotationManager.create(PointAnnotationOptions(
//             geometry: coordinate.toJson(),
//             iconImage: "assets/images/Group 71.png",
//             iconSize: 0.5,
//            ));
//         //addAnnotation(imageData, coordinate);
//       }
//
...
//     final start = Position(77.641151,12.971891);
//     final end = Point.fromJson((annotation.geometry)!.cast());
//
//     final coordinates = await fetchRouteCoordinates(
//         start, end.coordinates, 'pk.eyJ1IjoiaGVscHltb3RvIiwiYSI6ImNsamNscHVuejAyOXAzZG1vNXppYnM1NzkifQ.BB9fpPJb9eDpRJkWwkRHXA');
//
//     //final coordinates =await Coordinat
//
