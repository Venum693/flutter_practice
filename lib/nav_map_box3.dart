...
//   final LatLng _destination = const LatLng(37.7749, -122.5194);
//   List<LatLng> _route = [];
//   late Symbol _marker;
...
//     var image = await BitmapDescriptor.fromAssetImage( ImageConfiguration(devicePixelRatio: 2.5),
...
//               annotationConsumeTapEvents: null);
